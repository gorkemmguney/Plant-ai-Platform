...
from app.routers import admin, ai, auth, bundles, campaigns, catalog, complaints, coupons, customers, notifications, orders, reviews, locations, addresses, community
